...
class ParkingDetector:
    ...
    def save_current_status(self, occupied_count, total_spots):
        """Сохраняет текущий статус парковки в JSON файл для сайта"""
        status_data = {
            'occupied': occupied_count,
            'free': total_spots - occupied_count,
            'total': total_spots,
            'timestamp': time.time(),
            'spots': []
        }
        ...
        try:
            ...
            if self.frame_count % 100 == 0:
                print(f"Статус сохранен: {occupied_count}/{total_spots} занято")
    ...
    def draw_parking_info(self, frame):
        ...
        cv2.putText(frame, f"Status saved: {occupied_count}/{total_spots} occupied",
                    (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)

        cv2.putText(frame, "LMB: add 4-point spot, 'c': clear, 's': save, 'q': quit",
    ...
    def run(self):
        ...
        print("Этот файл можно использовать для отображения данных на сайте uCoz")
        ...
        try:
            ...
            print("Программа завершена. Парковочные места сохранены.")
            print(f"Файл '{self.status_file}' готов для использования на сайте uCoz")
